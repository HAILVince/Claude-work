...
form.addEventListener('submit', e => {
  e.preventDefault();
  const nev = form.nev, el = form.elerhetoseg, panasz = form.panasz;
  [nev, el, panasz].forEach(clear);
  ok.hidden = true;
  let bad = null;
  ...
  if (!panasz.value) { fail(panasz, 'Válassz egyet, vagy azt, hogy egyéb.'); bad ||= panasz; }
