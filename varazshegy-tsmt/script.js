/* Varázshegy TSMT — header state, mobile menu, booking form */
(function () {
  'use strict';
  ...
  /* ---------- booking form ----------------------------------------------
     ...
     practice's inbox. No server, no database, nothing to maintain.
  ...
  var validate = function () {
    ...
    [['f-name', 'Kérjük, adja meg a nevét.'],
     ['f-desc', 'Kérjük, írja le, mit tapasztalnak.']].forEach(function (p) {
  ...
  form.addEventListener('submit', function (e) {
    ...
    fetch('https://api.web3forms.com/submit', {
      ...
      .then(function (r) {
        ...
        say('ok', 'Megkaptuk',
          'Köszönjük a megkeresést! Igyekszünk pár napon belül válaszolni a megadott e-mail címre.');
        form.reset();
      ...
      .catch(function () {
        say('err', 'Nem sikerült elküldeni',
          'Kérjük, próbálja meg újra egy kicsit később.');
      })
      .then(function () {
